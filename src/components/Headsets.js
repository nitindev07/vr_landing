  ...
  return (
    <div className='container mx-auto py-14 mt-20'>
      ...
      <div className='grid grid-cols-1 lg:grid-cols-2 gap-5 lg:gap-y-6 gap-x-5'>
        <div data-aos='zoom-in' data-aos-offset='300' data-aos-delay='500' className='relative'>
          <img src={hdset1} alt="" />
        ...
        <div data-aos='zoom-in' data-aos-offset='300' data-aos-delay='700' className='relative'>
          <img src={hdset2} alt="" />
          <div className='absolute bottom-0 bg-white/20 backdrop-blur-md max-w-[300px] min-h-[150px] p-6'>
        ...
        <div data-aos='zoom-in' data-aos-offset='300' data-aos-delay='900' className='relative'>
          <img src={hdset3} alt="" />
          <div className='absolute bottom-0 bg-white/20 backdrop-blur-md max-w-[300px] min-h-[150px] p-6'>
        ...
        <div data-aos='zoom-in' data-aos-offset='300' data-aos-delay='1100' className='relative'>
          <img src={hdset4} alt="" />
          <div className='absolute bottom-0 bg-white/20 backdrop-blur-md max-w-[300px] min-h-[150px] p-6'>
