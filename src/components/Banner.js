    ...
    <div className='container mx-auto pt-24 pb-12 lg:pt-48 lg:pb-0 md:max-h-[850px] max-h-[1200px]   '>
      <div className='grid md:grid-cols-2 gap-14'>
        <div className='text-center lg:text-start flex flex-col gap-10' >
          ...
          <p data-aos='fade-down' data-aos-delay='600' className='max-w-[440px] mb-12 mx-auto lg:mx-0'>With Virtual Technology you can see the digital world feel more real and you can play the game with a new style.</p>
          
          <div data-aos='fade-down' data-aos-delay='700' className='flex justify-around space-x-4 lg:justify-start lg:space-x-8 items-center  max-w-[320px] mx-auto lg:mx-0 lg:max-w-none'>
